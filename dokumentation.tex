...
\end{figure}
 \clearpage
\section{Beurteilung durch den Domänenexperten}
...
\item Der Lastminuterabatt soll in Lastminutezuschlag umgewanldet werden.
...
Einem Domänenexperten, ohne Betriebswirtschaftlichen Hintergrund wurde die
vorhandenen DSL gezeigt und erklärt.
Dabei sollten die Fragen beantwortet werden. Der Experte war nur mit erheblicher
Hilfe dazu in der Lage die Fragen zu lösen.
Abschließend wurde es als ein geeignetes Kommunikationsmedium gutgeheissen. Da
die Kommunikation mit dem Programmierer nicht immer eindeutig ist.
Gegenüber einer grafischen Benutzeroberfläche wurde die DSL und deren Notation als ``verwirrend'' eingestuft.
Durch das fehlen einer Legende wurde der Lösungsweg weiterhin erschwert.
Eine Aufzeichnung\footnote{42 min - http://srvme.de/mda/aufgabenloesung.mp3}
von dem Interview schildert die Aufgabenlösung. 
...
Einfacher da kein aufwand für gui zu betreiben ist.
 - history wie bei einem vcs mit benutzen\ldots
